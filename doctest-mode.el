...
(defvar doctest-selected-failure)
(defvar doctest-async-process)
(defvar doctest-results-buffer)
(defvar doctest-source-buffer)
(defvar doctest-async-process-tempfile)
(defvar doctest-async-process)
(defvar doctest-example-markers)
(defvar doctest-selected-failure)
...
"
  ...
  (cond
   ...
   ((and (looking-at "[^ \t\n]\\|$") (doctest-looking-back doctest-prompt-re nil))
  ...
  (cond
   ...
   (t
    (let* ((results-buf-name (doctest-results-buffer-name))
      ...
      (with-current-buffer doctest-results-buffer
        (read-only-mode 0)
...
(cond ((fboundp 'looking-back) ;; Emacs 22.x
      ...
      (t
       (defun doctest-looking-back (regexp &optional limit)
